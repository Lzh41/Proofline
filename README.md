...
> 当前版本：`0.1.11` · Windows x64 · Tauri 2 · React 19 · SQLite
...
- `Proofline_0.1.11_x64-setup.exe`：Windows x64 安装版，可指定安装路径。
- `Proofline_0.1.11_x64-portable.exe`：Windows x64 便携版，免安装运行。
